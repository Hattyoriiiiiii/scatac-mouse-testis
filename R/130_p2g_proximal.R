...
outDir.proc <- "processed/13_p2g_proximal"
outDir.fig <- "figures/13_p2g_proximal"
outDir.res <- "results/13_p2g_proximal"
...
color <- as.vector(ArchRPalettes$stallion2)[1:13]
...
for (i in 1:km_number) {
    ...
    p2g_id <- p2g_id[p2g_id %in% p2g_proximal$p2g_id]
