# sh ../scripts/annotateEnhancers_exp07.sh > ../log/annotateEnhancers_exp07.log 2>&1
PARDIR="results/07_p2g_distal/CREs/exp_01"
OUT_META="results/07_p2g_distal/CREs/exp_01/metaplot"
